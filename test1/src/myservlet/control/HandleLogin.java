...
public class HandleLogin extends HttpServlet{
   ...
   public void doPost(HttpServletRequest request,HttpServletResponse response) 
      ...
      Connection con; 
      Statement sql; 
      String logname=request.getParameter("rname").trim(),
      password=request.getParameter("rpassword").trim();
      ...
      try{ 
           ...
           String condition="select * from user where rname = '"+logname+
            "' and rpassword ='"+password+"'";
